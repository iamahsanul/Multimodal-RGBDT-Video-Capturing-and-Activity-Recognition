%multimodal DT
%rgb load
load('D:\Hammel Research\Hammel Pilot data\Preprocess_GUI_pilot_rgb\feature_manual_cropped_radon_all');
rgb_features = all_event_features;

%thermal load
load('D:\Hammel Research\Hammel Pilot data\Preprocess_GUI_pilot_thermal\feature_manual_cropped_radon_all');
thermal_features = all_event_features;

% %depth load
% load('D:\Hammel Research\Hammel Pilot data\Preprocess_GUI_pilot_depth\feature_manual_cropped_gridResize_all.mat');
% depth_features = all_event_features;
% 
all_event_features = cat(1, rgb_features, thermal_features);
% all_event_features = cat(1, cat(1, rgb_features, thermal_features), depth_features);
